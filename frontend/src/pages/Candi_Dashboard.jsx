    ...
    return (
        <section className='bg-gradient-to-t from-[#c8e3ff] to-slate-50 w-screen h-screen overflow-hidden'>
            ...
            <div className='relative z-[0%]'>
                <img src={bg_circle} alt="" className='absolute right-[20%] top-24 blur-xl z-[0%]' />
            </div> */}
            ...
            <div className='p-6 left-[45%] bg-white w-[60%] mx-auto flex justify-center mt-6' >
                {/* Exam Card*/}
                <div className='flex flex-col items-center justify-center text-center border-4 border-gray-300 gap-y-4 w-[45%] mx-3 my-6 pb-6 rounded-md'>
                    <h2 className='mt-3 text-3xl font-semibold'>Internship Exam</h2>
                    <button className='w-[80%] bg-green-300 text font-medium py-2 rounded-md mt-3'>Start Exam</button>
